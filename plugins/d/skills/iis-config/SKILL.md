...
# When deciding where an IIS setting belongs: what goes in web.config
...
# When deciding where an IIS setting belongs: what stays in the deployment/install script
...
# When reviewing a deployment or install script
